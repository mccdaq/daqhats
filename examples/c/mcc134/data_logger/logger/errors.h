...
extern const char* get_mcc134_error_message(int error_code);
extern gboolean show_error(const char* errmsg);
extern void show_mcc134_error_main_thread(gpointer error_code);
extern void show_mcc134_error(int error_code);
